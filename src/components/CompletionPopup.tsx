      ...
      {info && (
        ...
        >
          ...
          <motion.div
            ...
            transition={reduceMotion ? { duration: 0 } : { duration: 0.15 }}
            className="relative w-full max-w-[360px] card-elevated p-6 flex flex-col items-center gap-3 text-center"
            // True overlay — tight dark shadow allowed (law 3); inline because
            // .card-elevated's unlayered `box-shadow: none` wins over utilities.
            style={{ boxShadow: "var(--shadow-md)" }}
          >
            {/* Phosphor = the "valid reading" signal — the one lit element here. */}
            <div className="w-10 h-10 rounded bg-[var(--phosphor-well)] border border-[var(--phosphor-dim)] flex items-center justify-center">
              <Check className="w-5 h-5 text-[var(--phosphor)]" strokeWidth={2.5} />
            </div>
            <div>
